...
Donate link: https://ays-pro.com/index.php/wordpress/quiz-maker
...
**[PRO](https://ays-pro.com/wordpress/quiz-maker/) Features**
...
* [Classic Dark theme](https://freedemo.ays-pro.com/random-quiz-test-1/)
* [Classic Light theme](https://freedemo.ays-pro.com/random-quiz-2/)
* [Elegant Dark theme](https://freedemo.ays-pro.com/random-quiz-3/)
* [Rect Light theme](https://freedemo.ays-pro.com/random-quiz-4/)
...
3.  WordPress Quiz Plugin - dashboard edit quiz page
4.  WordPress Quiz Plugin - dashboard edit quiz styles page
5.  WordPress Quiz Plugin - dashboard quiz
6.  WordPress Quiz Plugin - dashboard quizzes list
7.  WordPress Quiz Plugin - dashboard edit quiz settings page
8.  WordPress Quiz Plugin - front end quiz theme
9.  WordPress Quiz Plugin - front end quiz theme
