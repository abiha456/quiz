                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label class="form-check-label" for="ays-pass-score">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('The minimum score to pass the quiz (by percentage). User results will not be saved in the database if he/she will not pass the quiz.',$this->plugin_name)?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8" id="ays_mail_message_div">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="checkbox" class="ays-enable-timerl" id="ays_send_results_user" value="on" checked/>
                                    </div>
                                </div>
                                <hr/>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="checkbox" class="ays-enable-timerl" id="ays_send_interval_msg" checked/>
                                    </div>
                                </div>
                            </div>
                        </div>
