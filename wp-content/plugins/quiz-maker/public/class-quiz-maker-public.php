        ...
        foreach($ids as $key => $id){
            ...
            if (!empty($question)) {
                ...
                if (isset($question['question_hint']) && strlen($question['question_hint']) !== 0) {
                    ...
                    $question_hint = "<div class='ays_question_hint_container'><i class='ays_fa ays_fa_info_circle ays_question_hint' aria-hidden='true'></i><span class='ays_question_hint_text'>" . $question_hint . "</span></div>";
                }
